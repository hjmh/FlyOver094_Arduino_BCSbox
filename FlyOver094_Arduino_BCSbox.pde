  ...
  #ifndef VRiD_ArduinoMain_h
  #define VRiD_ArduinoMain_h
  #include <SPI.h>// include the SPI library code
  #include <VRiD_VRsetup_v0021_2.h> // include library for setting up the communication etc.
  #include <VRiD_VRcontrol_v0021_2.h> // include library for control of VR setup
  #include <VRiD_Arduino_ExpParams.h> // include parameter declarations and initializations
  ...
  VRiD_VRsetup VRsetup(lowestPin, highestPin, dac2pin);
  VRiD_VRcontrol VRcontrol_DataPC(timeOutInterval_DataPC, dacScreenLED, dacBasler, dacIRLaser, CALIBRATION_HZ, CALIBRATION_PULSE_TIME, dac2pin);
  VRiD_VRcontrol VRcontrol_VRPC(timeOutInterval_VRPC, dacScreenLED, dacBasler, dacIRLaser, CALIBRATION_HZ, CALIBRATION_PULSE_TIME, dac2pin);
